...
{
    ////创建武器组件
    //WeaponComponent = CreateAbstractDefaultSubobject<USTUAIWeaponComponent>("WeaponComponent");
...
void ASTUAICharacter::OnDeath()
{
    ...
    {
        STUController->BrainComponent->Cleanup();//玩家死亡停止行为树
    }
}
...
void ASTUAICharacter::OnHealthChanged(float Health, float HealthDelta)
{
    ...
    HealthBarWidget->SetHealthPercent(HealthComponent1->GetHealthPercent());
}
/// <summary>
/// 当距离较远时，关闭AI的血量UI
/// </summary>
